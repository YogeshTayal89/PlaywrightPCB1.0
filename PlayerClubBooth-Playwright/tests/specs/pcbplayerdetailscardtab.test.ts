...
test.describe('PCB Player Detail Cards Tab Suite', () => {
  ...
  test.beforeEach(async ({ page }) => {
    ...
    test('Scenario Outline: As a user , I can navigate to player details Card tab page @CardsTab @Smoke @Regression', async ({ page }) => {
    ...
    test('Scenario Outline: As a user , I can add the correct pin  @CardsTab @Regression', async ({ page }) => {
        await test.step('Then I can navigate to Cards tab page', async () => {
            const pcpplayercarddetailpage=new PCBPlayerCardDetailsPage(page);
            await pcpplayercarddetailpage.verifyCardDetailsPageIsPresent()
        });
        await test.step('Then I can set the pin ', async () => {
            const pcpplayercarddetailpage=new PCBPlayerCardDetailsPage(page);
            await pcpplayercarddetailpage.addCorrectPIN();
        });

    });

    test('Scenario Outline: As a user , I can update the correct pin  @CardsTab @Regression', async ({ page }) => {
        await test.step('Then I can navigate to Cards tab page', async () => {
            const pcpplayercarddetailpage=new PCBPlayerCardDetailsPage(page);
            await pcpplayercarddetailpage.verifyCardDetailsPageIsPresent()
        });
        await test.step('Then I can set the pin ', async () => {
            const pcpplayercarddetailpage=new PCBPlayerCardDetailsPage(page);
            await pcpplayercarddetailpage.updateCorrectPIN();
        });
